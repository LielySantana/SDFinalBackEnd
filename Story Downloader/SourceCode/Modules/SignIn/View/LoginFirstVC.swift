    ...
    @IBAction func continueBtnPress(_ sender: UIButton) {
        ...
        Purchases.shared.getCustomerInfo { (customerInfo, error) in
            ...
            if customerInfo.entitlements.active.isEmpty == true {
                ...
                if let secondViewController = parentVC.vcList[1] as? LoginSecondVC {
                    parentVC.setViewControllers([secondViewController], direction: .forward, animated: false, completion: nil)
...
extension LoginFirstVC:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
